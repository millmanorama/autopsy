...
class SampleFileIngestModule implements FileIngestModule {
    ...
    public IngestModule.ProcessResult process(AbstractFile file) {
        ...
        try {
             ...
             * for keyword search, add any events that can be derived from it,
             * and notify the UI via a ModuleDataEvent.
             */
            file.getSleuthkitCase().getBlackboard().postArtifact(SampleIngestModuleFactory.getModuleName(), art);
